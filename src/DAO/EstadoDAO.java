...
public class EstadoDAO implements IDAO_T<Estado> {
    ...
    public String salvar(Estado o) {
        ...
        try {
            ...
            System.out.println("Erro inserir estados = " + e);
            return e.toString();
        }
    ...
    public String atualizar(Estado o) {
        try {
            ...
            System.out.println("Erro atualizar estados = " + e);
            return e.toString();
        }
    }
    ...
    public String excluir(int id) {
        try {
            ...
            System.out.println("Erro excluir/inativar estados = " + e);
            return e.toString();
        }
    }
    ...
    public ArrayList<Estado> consultarTodos() {
        ...
        try {
            ...
            while (resultadoQ.next()) {
                ...
                estado.setDescricao(resultadoQ.getString("descricao"));
    ...
    public Estado consultarId(int id) {
        ...
        try {
            ...
            System.out.println("Erro consultar estados = " + e);
        }
        return u;
    }
    ...
    public void popularTabela(JTable tabela, String criterio) {
        ...
        try {
            String sql = ""
                    + "SELECT id, uf, descricao FROM estados "
                    + "WHERE  "
                    + "descricao ILIKE '%" + criterio + "%' "
                    + "ORDER BY descricao";
            ...
            while (resultadoQ.next()) {
                ...
                dadosTabela[lin][1] = resultadoQ.getString("uf");
